  ...
  useEffect(() => {
    ...
    const verifyEmail = async () => {
      try {
        ...
        // ✅ Improved error handling (granular)
        if (isAxiosError(err)) {
        ...
        } else if ((err as { name: string })?.name === 'CanceledError') {
    ...
    return (
      <AuthLayout title="Email verification">
        <div className="py-4 space-y-5 text-center">
          ...
          <Alert variant="error">No verification token found in the link.</Alert>
